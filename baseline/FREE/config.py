...
parser.add_argument('--nclass_all', type=int, default=18278, help='number of all classes')
...
#############################################################
parser.add_argument('--result_root', type=str, default='/ibex/scratch/shenx/FREE-main/result', help='root path for saving checkpoint')
parser.add_argument('--center_margin', type=float, default=983, help='the margin in the center loss')
...
parser.add_argument('--nclass_seen', type=int, default=983, help='number of seen classes')
...
#################################################################
parser.add_argument('--load_G', type=str)
parser.add_argument('--load_F', type=str)
